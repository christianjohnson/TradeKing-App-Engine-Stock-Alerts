    ...
    for user, alerts in users.items():
      for alert in alerts:
        ...
        if prices[ticker] > hi_price:
          self.response.out.write("Broke above " + user.nickname() + "'s limit of " + str(hi_price) + " for " + ticker)
        if prices[ticker] < low_price:
          self.response.out.write("Broke below " + user.nickname() + "'s limit of " + str(low_price) + " for " + ticker)
